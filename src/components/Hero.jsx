...
const Hero = () => {
    ...
    const handleVideoLoaded = () => {
        setLoadedVideos(prev => (prev === totalVideos - 1) ? prev : prev + 1);
    }
    ...
    return (
        <div className="relative h-dvh w-screen overflow-x-hidden">
            ...
            {isLoading && (
                <div className='flex-center absolute z-[100] w-dvw h-dvh overflow-hidden bg-violet-50'>
            ...
            <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75">
                ...
                <video
                    ...
                    onLoadedData={handleVideoLoaded}
                />
                <h1 className="absolute bottom-5 right-5 z-40 special-font hero-heading text-blue-75">G<b>a</b>ming</h1>
                ...
                <div className="absolute z-40 top-0 left-0 size-full">
                    <div className="mt-24 px-5 sm:px-10">
                        ...
                        <p className="mb-5 max-w-64 font-robert-regular text-blue-100">Enter the Metagame Layer<br/>
                            Unleash the Player Economy</p>
                        <Button id="watch-trailer" title="Watch Trailer" leftIcon={<TiLocationArrow/>}
                                containerClass="!bg-yellow-300 flex-center gap-1"/>
                    </div>
                </div>
            </div>
            <h1 className="absolute bottom-5 right-5 special-font hero-heading text-black">G<b>a</b>ming</h1>
        </div>
    );
};
